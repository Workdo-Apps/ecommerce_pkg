// ignore_for_file: prefer_const_constructors, constant_identifier_names, avoid_print, unused_local_variable, sized_box_for_whitespace, unused_element

import 'package:ecommerce_pkg/widget/custom_bottom_nav_bar/reused_gradient.dart';
import 'package:ecommerce_pkg/widget/custom_bottom_nav_bar/styles.dart';
        ...
        Positioned.fill(
          ...
          child: Row(
            ...
            children: List.generate(widget.count, (index) {
              ...
              return Padding(
                // padding: EdgeInsets.only(top: index == 2 ? 0 : 30, left: 12, right: index == 2 ? 0 : 12),
